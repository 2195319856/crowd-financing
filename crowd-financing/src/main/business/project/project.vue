    ...
    <div  style="width:95%;text-align: left;border:1px solid #EBEEF5;border-radius: 4px;padding: 9px">
        ...
        <div>
            <el-table :data="tableData" border  width="100%"  @selection-change="handleSelectionChange">
                <el-table-column  prop="date" label="项目名称" min-width="10%">
                </el-table-column>
                <el-table-column prop="name" label="发起人" min-width="10%">
                </el-table-column>
                <el-table-column prop="zip" label="目标金额（元）" min-width="10%">
                </el-table-column>
                <el-table-column prop="zip" label="众筹周期(天)" min-width="10%">
                </el-table-column>
                <el-table-column prop="zip" label="创建时间" min-width="10%">
                </el-table-column>

    ...
    <div  style="width:95%;text-align: left;border:1px solid #EBEEF5;border-radius: 4px;padding: 9px">
        ...
        <div>
            <el-table :data="tableData" border  width="100%"  @selection-change="handleSelectionChange">
                <el-table-column  prop="date" label="流程名称" min-width="10%">
                </el-table-column>
                <el-table-column prop="name" label="流程版本" min-width="10%">
                </el-table-column>
                <el-table-column prop="zip" label="任务名称" min-width="10%">
                </el-table-column>
                <el-table-column prop="zip" label="申请会员" min-width="10%">
                </el-table-column>
